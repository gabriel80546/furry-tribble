...
echo -e "\$? = $?"
gcc -Werror -Og -g -o  ../engine ./temp/engine.c
if [ $? -eq 0 ]
then
...
gcc -Werror -O1 -g -o  z/engineO1 ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
...
gcc -Werror -O2 -g -o  z/engineO2 ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
...
gcc -Werror -O3 -g -o  z/engineO3 ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
...
gcc -Werror -O0 -g -o  z/engineO0 ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
...
gcc -Werror -Os -g -o  z/engineOs ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
...
gcc -Werror -Ofast -g -o  z/engineOfast ./temp/engine.c
if [ $? -eq 0 ]
then
	echo -e "\033[1;32mCompilaçao deu certo\033[0m"
else
